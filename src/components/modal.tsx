                      ...
                      <div className="grid w-full gap-8 md:grid-cols-2">
                        ...
                        <div className="flex flex-col gap-4 rounded-lg border p-6">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Perfect for those starting their modelling journey.
                            Gain access to essential training and begin your
                            path to success.
                          </p>
                          <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                              <CheckCircle className="h-5 w-5 text-green-500" />
                              <span>More Than Skin Deep (1 Session/Month)</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <CheckCircle className="h-5 w-5 text-green-500" />
                        ...
                        <div className="flex flex-col gap-4 rounded-lg border border-primary bg-primary/5 p-6">
                          ...
                          <p className="text-sm text-muted-foreground">
                            For those ready to elevate their skills. Dive deeper
                            into modelling with enhanced training and growth
                            opportunities.
                          </p>
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              <CheckCircle className="h-5 w-5 text-green-500" />
                              <span>General Photoshoots (1 Session/Term)</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <CheckCircle className="h-5 w-5 text-green-500" />
                              <span>
