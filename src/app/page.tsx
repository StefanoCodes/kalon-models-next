          ...
          <h1 className="flex flex-col items-center justify-center gap-0 py-3 text-[2.1875rem] leading-[1.2] text-[#232121] md:py-0 md:text-[4.375rem]">
            <span className="flex min-h-max items-center gap-1 md:gap-2">
              ...
              <span className="relative px-4 pb-3 pt-2 text-[2.1875rem] text-[#B1B4B9] md:px-3 md:pb-3 md:pt-[1px] md:text-[4.375rem]">
                ...
                <div className="absolute left-0 top-[8px] w-[100%] border border-[#E3E8EA] md:-left-[3px] md:w-[103%]" />
                <div className="absolute bottom-2 left-0 w-[100%] border border-[#E3E8EA] md:-left-[3px] md:w-[103%]" />
                <div className="absolute left-2 top-[0px] h-[98%] border border-[#E3E8EA] md:-top-[3px] md:h-[105%]" />
                <div className="absolute right-2 top-[0px] h-[98%] border border-[#E3E8EA] md:-top-[3px] md:h-[105%]" />
              </span>
            </span>
