...
export default function RegistrationFormImg() {
  return (
    <div className="relative min-h-[300px] w-full md:flex-1">
      <Image
        fill
        ...
        alt="founder image"
        className="h-full w-full rounded-t-2xl object-cover transition-all duration-300 ease-in-out md:rounded-l-none md:rounded-r-2xl"
        priority
      />
