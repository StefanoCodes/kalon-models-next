      ...
      <div className="col-span-12 lg:col-span-12 xl:col-span-8">
        <div className="flex flex-col gap-4">
          <p className="text-2xl text-[#0A0A0A]">
            ...
            2020, we’ve trained 65+ models, helping them find their place in the
            industry, from runway to pageantry, personal branding, and beyond.
          </p>
          <p className="text-2xl font-normal text-[#0A0A0A]">
            With a dedicated team of 7+ experienced professionals, some of whom
            have worked with the likes of Maxhosa, David Tlale, and SAFW, we’re
            proud to be shaping the future of modeling in Pretoria, Johannesburg
            and Cape Town.
          </p>
          <p className="text-2xl font-normal text-[#0A0A0A]">
            Whether it’s your first step on the runway or your hundredth, Kalon
